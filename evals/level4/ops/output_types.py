    ...
    def __eq__(self, other: object) -> bool:
        ...
        return (
            ...
            and are_strings_similar(
                ...
                other.most_frequent_anomaly_machine.recommendation,
            )
        )
...
class MachineAgeAnalysisResponse(BaseModel):
    ...
    def __eq__(self, other: object) -> bool:
        ...
        return (
            ...
            and len(self.recent_maintenance_for_oldest_maintenance_machines)
            == len(other.recent_maintenance_for_oldest_maintenance_machines)
            and are_strings_similar(
                self.analysis_and_intervention_suggestion.analysis,
                other.analysis_and_intervention_suggestion.analysis,
            )
            and are_strings_similar(
                self.analysis_and_intervention_suggestion.intervention_suggestion,
                other.analysis_and_intervention_suggestion.intervention_suggestion,
            )
        )
