...
from .output_types import Expense, Expenses, ProductCount, RevenueAmount, TotalAmount, TotalRevenue
    ...
    cases=[
        ...
        Case(
            ...
            expected_output=QueryResult(
                result=Expenses(
                    expenses=[
                        Expense(expense_id=19, description="Expense 19: Event Sponsorship", amount=1000),
                        Expense(expense_id=18, description="Expense 18: Software Upgrade", amount=900),
                        Expense(expense_id=17, description="Expense 17: Travel", amount=700),
                    ]
                ),
                tool_calls=[
                    ToolCall(
